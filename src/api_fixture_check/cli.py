...
from api_fixture_check import __version__
from api_fixture_check.core import (
    audit_records,
    read_records,
    render_json,
    render_markdown,
...
from api_fixture_check.rules import PROJECT_NAME


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog='api-fixture-check',
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        help='fixture JSON, text, or review notes',
    )
    parser.add_argument(
        "--format",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"api-fixture-check: error: {exc}", file=sys.stderr)
        return 1
